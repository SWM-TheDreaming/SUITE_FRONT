...
const ContractUi = (props: ContractContentProps) => {
  ...
  return (
        <View>
            <TouchableOpacity
                style={SuiteRoomStyleSheet.ContractBox}
            ...
            <View style={mainPageStyleSheet.innerbox}>
                ...
                <View style={{flexDirection : 'row', justifyContent : 'space-between', alignItems : 'center'}}>
                    ...
                    <Text style={SuiteRoomStyleSheet.detailtext}>
                    {'계약서 함수 : ' + props.tx_func_name}
                    </Text>
                    <Text style={SuiteRoomStyleSheet.detailtext}>
                    {'요청자 : ' + props.tx_originator}
                    </Text>
                    </View>
            ...
            <ContractCheckModal visible={visible}>
              <ContractContentModalPopup visible={visible} onClose={() => setVisible(false)} text={props.tx_data} contract_address={props.contract_address} block_number={props.block_number} tx_fee={props.tx_fee} hashed_key={props.hashed_key}/>
            </ContractCheckModal>
        </View>
  );
};
