    ...
    return (
        <View>
            ...
            <TextInput
                ...
                textAlign='center'
            /> 
            {incorrect == true ? <Text style={SuiteRoomStyleSheet.IncorrectAttendanceText}>출석번호가 일치하지 않습니다!</Text> : null}
        ...
        <ModalPopup visible={okVisible}>
          <AttendanceCheckOkModaPopup visible={okVisible} onClose={() => setOkVisible(false)} text='출석이 완료되었습니다!' onConfirm = {() => onClose() }/>
        </ModalPopup>
      </View>
    );
};
